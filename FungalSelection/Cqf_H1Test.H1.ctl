      seqfile = Cqf_H1Test.codonalign.phy   * sequence data filename
     treefile = Cqf_H1Test.ConstrainedNodes.H1.tre      * tree structure file name
      outfile = Cqf_H1Test.H1.out   * main result file name
